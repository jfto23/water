...
// the original library uses egui version 0.29 which conflicts with bevy_egui_inspector
use std::collections::HashMap;

use bevy::prelude::*;
use egui::{
    epaint::{PathShape, RectShape},
    pos2, remap, vec2, Color32, Rect, Rgba, RichText, Rounding, Sense, Shape, Stroke, TextStyle,
    Vec2, WidgetText,
};

use bevy_renet::renet::{ClientId, NetworkInfo, RenetServer};
