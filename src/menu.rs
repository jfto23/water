...
const HOVERED_BUTTON: Color = Color::srgb(1., 0., 0.);
    ...
    commands
        ...
        .with_children(|parent| {
            parent
                ...
                .with_children(|parent| {
                    // this time not setting its `flex_direction`. It will
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            ...
                            parent.spawn(Text::new("Display Quality"));
                            ...
                            for quality_setting in [
                                ...
                                entity.with_children(|parent| {
                                    parent.spawn(Text::new(format!("{quality_setting:?}")));
                                });
